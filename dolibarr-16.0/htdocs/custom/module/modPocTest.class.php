...
class modPocTest extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 428400; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'poctest';
		...
		$this->descriptionlong = "This is a Test Module";
		...
		$this->dirs = array("/poctest/temp");

		// Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@poctest");
		...
		$this->langfiles = array("poctest@poctest");
